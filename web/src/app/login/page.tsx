  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "80vh" }}>
      <div className="card" style={{ width: "100%", maxWidth: "400px" }}>
        <h2 className="page-title" style={{ fontSize: "22px", marginBottom: "20px" }}>Sign In to AlphaLab</h2>
        ...
        <div style={{ marginTop: "20px", fontSize: "12px", textAlign: "center", color: "var(--text-muted)" }}>
          Don't have an account? <Link href="/register" style={{ color: "var(--accent)", fontWeight: 600, textDecoration: "none" }}>Register</Link>
        </div>
      </div>
    </div>
  );
